...
|---|---|
| **Goals & Outcomes** | Definiujesz cele firmy (np. "Weekly active teams do 1000 do końca Q1"): nazwa + metryka + target + termin. Taski i projekty przypisujesz do konkretnego celu — dzięki temu praca zespołu jest spięta z outcome'ami, a nie luźną listą ficzerów. W jednym widoku masz aktualną wartość metryki i wszystko, co pod nią pracuje. |
...
| **Slack Integration** | Powiadomienia do Slacka, kiedy coś się dzieje z twoimi celami: raport po wypuszczeniu funkcjonalności jest gotowy, metryka spadła poniżej progu, ktoś przypisał nowy task pod cel. Każdy goal możesz kierować do osobnego kanału Slacka, żeby właściwy zespół widział właściwe alerty. |
